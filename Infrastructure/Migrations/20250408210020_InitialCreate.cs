    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AsignacionesPermisos", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AsignacionesPermisos_Permisos_PermisoId",
                        column: x => x.PermisoId,
                        principalTable: "Permisos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AsignacionesPermisos_Roles_RolId",
                        column: x => x.RolId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UsuarioEliminado = table.Column<bool>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AsignacionesPermisos_PermisoId",
                table: "AsignacionesPermisos",
                column: "PermisoId");

            migrationBuilder.CreateIndex(
                name: "IX_AsignacionesPermisos_RolId",
                table: "AsignacionesPermisos",
                column: "RolId");
